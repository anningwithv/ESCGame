...
#region 处理AssetBundle Name
        ...
        //[MenuItem("Assets/GameFramework/Asset/标记AB名字[文件夹])")]
        ...
        //自动设置选中目录下的AssetBundle Name
        //[MenuItem("Assets/GameFramework/Asset/标记AB名字[文件])")]
...
#region 构建所有AssetBundle
        [MenuItem("Assets/GameFramework/Asset/构建AB[全局])")]
...
#region 指定具体文件构建
        ...
        [MenuItem("Assets/GameFramework/Asset/构建AB[当前文件夹]")]
...
#region 构建 AssetDataTable
        ...
        [MenuItem("Assets/GameFramework/Asset/生成Asset清单")]
		...
		[MenuItem("Assets/GameFramework/Res/清理无效AB")]
        ...
        /*
        [MenuItem("Assets/GameFramework/Asset/生成Asset清单[当前文件夹]")]
        ...
        */
        ...
        [MenuItem("Assets/GameFramework/Asset/生成Table清单")]
