...
namespace GameFrame
{
    public class TableReadThreadWork
    {
        class TableInfo
        {
            ...
            public TableInfo(GameFrame.DTableOnParse parseRun, string fileName)
            {
        ...
        private static ReadParams CreateReadParams(GameFrame.DTableOnParse onParse, string tableName)
        {
        ...
        public void AddJob(string tableName, GameFrame.DTableOnParse onParse = null)
        {
            if (onParse == null)
            {
                return;
        ...
        public static void ReadSync(GameFrame.DTableOnParse onParse, string fileName)
        {
