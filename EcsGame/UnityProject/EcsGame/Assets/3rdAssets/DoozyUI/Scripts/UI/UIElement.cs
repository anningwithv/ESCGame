...
namespace DoozyUI
{
    ...
    public class UIElement : MonoBehaviour
    {
        ...
        private GameFrame.AbstractPanel _maybePanel;
        public void Reset()
        {
        ...
        void Awake()
        {
            ...
            _maybePanel = gameObject.GetComponent<GameFrame.AbstractPanel>();
        ...
        void ToggleCanvasAndGraphicRaycaster(bool isEnabled)
        {
            ...
            if (!disableGraphicRaycaster)
            {
                ...
                if (_maybePanel != null)
                {
                    bool isPanelMask = GameFrame.UIMgr.S.topPanelHideMask == GameFrame.PanelHideMask.UnInteractive
                                        || _maybePanel.hideMask == GameFrame.PanelHideMask.UnInteractive;
